...
import '../data/datasources/remote/search_api_service.dart' as _i63;
...
import '../data/repositories/search_repository_impl.dart' as _i65;
...
import '../domain/repositories/search_repository.dart' as _i64;
...
import '../domain/usecases/clear_cache_usecase.dart' as _i73;
import '../domain/usecases/create_new_pin_usecase.dart' as _i24;
import '../domain/usecases/fill_your_profile_usecase.dart' as _i28;
import '../domain/usecases/get_bookmark_fetch_usecase.dart' as _i71;
import '../domain/usecases/get_contact_fetch_usecase.dart' as _i18;
import '../domain/usecases/get_countries_usecase.dart' as _i84;
import '../domain/usecases/get_course_details_fetch_usecase.dart' as _i76;
import '../domain/usecases/get_course_fetch_usecase.dart' as _i77;
import '../domain/usecases/get_course_lessons_fetch_usecase.dart' as _i78;
...
import '../domain/usecases/get_helper_center_usecase.dart' as _i85;
import '../domain/usecases/get_home_fetch_usecase.dart' as _i88;
import '../domain/usecases/get_invite_friends_usecase.dart' as _i30;
import '../domain/usecases/get_languages_usecase.dart' as _i86;
import '../domain/usecases/get_mentor_courses_fetch_usecase.dart' as _i91;
import '../domain/usecases/get_mentor_fetch_usecase.dart' as _i93;
...
import '../domain/usecases/get_notification_fetch_usecase.dart' as _i96;
...
import '../domain/usecases/get_recent_search_fetch_usecase.dart' as _i100;
import '../domain/usecases/get_search_fetch_usecase.dart' as _i102;
...
import '../domain/usecases/post_bookmark_addition_usecase.dart' as _i70;
import '../domain/usecases/post_bookmark_removal_usecase.dart' as _i72;
...
import '../domain/usecases/post_recent_search_addition_usecase.dart' as _i99;
import '../domain/usecases/post_recent_search_removal_usecase.dart' as _i101;
import '../domain/usecases/sign_in_usecase.dart' as _i66;
import '../domain/usecases/sign_up_usecase.dart' as _i67;
import '../domain/usecases/update_profile_usecase.dart' as _i69;
import '../module/register_module.dart' as _i113;
...
import '../presentation/course_detail_payment_enroll/review/bloc/review_bloc.dart'
    as _i62;
import '../presentation/edit_profile/bloc/edit_profile_bloc.dart' as _i109;
...
import '../presentation/friends_invitation/bloc/friends_invitation_bloc.dart'
    as _i83;
import '../presentation/help_center/bloc/helper_center_bloc.dart' as _i87;
import '../presentation/home_and_action_menu/home/bloc/home_bloc.dart' as _i110;
...
import '../presentation/home_and_action_menu/top_mentors/bloc/top_mentors_bloc.dart'
    as _i105;
import '../presentation/language/bloc/language_bloc.dart' as _i89;
import '../presentation/lets_in/sign_in/bloc/sign_in_bloc.dart' as _i103;
import '../presentation/lets_in/sign_up/bloc/sign_up_bloc.dart' as _i104;
import '../presentation/my_course/my_completed_course/bloc/my_complete_course_bloc.dart'
    as _i94;
import '../presentation/my_course/my_courses/bloc/my_course_bloc.dart' as _i95;
...
import '../presentation/profile/bloc/profile_bloc.dart' as _i61;
import '../presentation/transactions/bloc/transactions_bloc.dart' as _i68;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i61.ProfileBloc>(() => _i61.ProfileBloc(
      get<_i32.GetProfileUseCase>(), get<_i42.LanguageUseCase>()));
  gh.factory<_i62.ReviewBloc>(
      () => _i62.ReviewBloc(get<_i23.CourseReviewsFetchUseCase>()));
  gh.lazySingleton<_i63.SearchApiService>(() => registerModule.searchApiService(
      get<_i4.Dio>(instanceName: 'ApiDio'),
      get<String>(instanceName: 'ApiBaseUrl')));
  gh.factory<_i64.SearchRepository>(
      () => _i65.SearchRepositoryImpl(get<_i63.SearchApiService>()));
  gh.factory<_i66.SignInUseCase>(
      () => _i66.SignInUseCase(get<_i10.UserRepository>()));
  gh.factory<_i67.SignUpUseCase>(
      () => _i67.SignUpUseCase(get<_i10.UserRepository>()));
  gh.factory<_i68.TransactionsBloc>(
      () => _i68.TransactionsBloc(get<_i33.GetTransactionsUseCase>()));
  gh.factory<_i69.UpdateProfileUseCase>(
      () => _i69.UpdateProfileUseCase(get<_i10.UserRepository>()));
  gh.factory<_i70.BookmarkAdditionUseCase>(
      () => _i70.BookmarkAdditionUseCase(get<_i16.BookmarkRepository>()));
  gh.factory<_i71.BookmarkFetchUseCase>(
      () => _i71.BookmarkFetchUseCase(get<_i16.BookmarkRepository>()));
  gh.factory<_i72.BookmarkRemovalUseCase>(
      () => _i72.BookmarkRemovalUseCase(get<_i16.BookmarkRepository>()));
  gh.factory<_i73.ClearCacheUseCase>(
      () => _i73.ClearCacheUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i74.ConfirmPaymentBloc>(
      () => _i74.ConfirmPaymentBloc(get<_i59.PinValidationUseCase>()));
  gh.factory<_i75.ContactSelectionBloc>(() => _i75.ContactSelectionBloc(
      get<_i19.ContactSelectionUseCase>(), get<_i18.ContactFetchUseCase>()));
  gh.factory<_i76.CourseDetailsFetchUseCase>(
      () => _i76.CourseDetailsFetchUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i77.CourseFetchUseCase>(
      () => _i77.CourseFetchUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i78.CourseLessonsFetchUseCase>(
      () => _i78.CourseLessonsFetchUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i79.CreateNewPinBloc>(
      () => _i79.CreateNewPinBloc(get<_i24.CreateNewPinUseCase>()));
  gh.factory<_i80.EReceiptBloc>(
      () => _i80.EReceiptBloc(get<_i29.GetEReceiptUseCase>()));
  gh.factory<_i81.EnrollCourseBloc>(() => _i81.EnrollCourseBloc(
      get<_i31.GetPaymentsUseCase>(), get<_i60.PostEnrollCourseUseCase>()));
  gh.factory<_i82.FillYourProfileBloc>(
      () => _i82.FillYourProfileBloc(get<_i28.FillYourProfileUseCase>()));
  gh.factory<_i83.FriendsInvitationBloc>(() => _i83.FriendsInvitationBloc(
      get<_i30.GetInviteFriendsUseCase>(), get<_i40.InviteFriendUseCase>()));
  gh.factory<_i84.GetCountriesUseCase>(
      () => _i84.GetCountriesUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i85.GetHelperCenterUseCase>(
      () => _i85.GetHelperCenterUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i86.GetLanguagesUseCase>(
      () => _i86.GetLanguagesUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i87.HelperCenterBloc>(
      () => _i87.HelperCenterBloc(get<_i85.GetHelperCenterUseCase>()));
  gh.factory<_i88.HomeFetchUseCase>(
      () => _i88.HomeFetchUseCase(get<_i38.HomeRepository>()));
  gh.factory<_i89.LanguageBloc>(() => _i89.LanguageBloc(
      get<_i86.GetLanguagesUseCase>(), get<_i41.LanguageSaveUseCase>()));
  gh.factory<_i90.LessonBloc>(
      () => _i90.LessonBloc(get<_i78.CourseLessonsFetchUseCase>()));
  gh.factory<_i91.MentorCoursesFetchUseCase>(
      () => _i91.MentorCoursesFetchUseCase(get<_i45.MentorRepository>()));
  gh.factory<_i92.MentorDetailsBloc>(() => _i92.MentorDetailsBloc(
      get<_i91.MentorCoursesFetchUseCase>(),
      get<_i48.MentorStudentsFetchUseCase>(),
      get<_i47.MentorReviewsFetchUseCase>()));
  gh.factory<_i93.MentorFetchUseCase>(
      () => _i93.MentorFetchUseCase(get<_i45.MentorRepository>()));
  gh.factory<_i94.MyCompleteCourseBloc>(
      () => _i94.MyCompleteCourseBloc(get<_i49.MyCourseDetailFetchUseCase>()));
  gh.factory<_i95.MyCourseBloc>(
      () => _i95.MyCourseBloc(get<_i50.MyCourseFetchUseCase>()));
  gh.factory<_i96.NotificationFetchUseCase>(
      () => _i96.NotificationFetchUseCase(get<_i54.NotificationRepository>()));
  gh.factory<_i97.PasswordCreationBloc>(
      () => _i97.PasswordCreationBloc(get<_i56.PasswordCreationUseCase>()));
  gh.factory<_i98.PinEntryBloc>(() => _i98.PinEntryBloc(
      get<_i58.PinSendingUseCase>(), get<_i59.PinValidationUseCase>()));
  gh.factory<_i99.RecentSearchAdditionUseCase>(
      () => _i99.RecentSearchAdditionUseCase(get<_i64.SearchRepository>()));
  gh.factory<_i100.RecentSearchFetchUseCase>(
      () => _i100.RecentSearchFetchUseCase(get<_i64.SearchRepository>()));
  gh.factory<_i101.RecentSearchRemovalUseCase>(
      () => _i101.RecentSearchRemovalUseCase(get<_i64.SearchRepository>()));
  gh.factory<_i102.SearchFetchUseCase>(
      () => _i102.SearchFetchUseCase(get<_i64.SearchRepository>()));
  gh.factory<_i103.SignInBloc>(() => _i103.SignInBloc(
      get<_i66.SignInUseCase>(), get<_i12.AccessTokenSaveUseCase>()));
  gh.factory<_i104.SignUpBloc>(
      () => _i104.SignUpBloc(get<_i67.SignUpUseCase>()));
  gh.factory<_i105.TopMentorsBloc>(
      () => _i105.TopMentorsBloc(get<_i93.MentorFetchUseCase>()));
  gh.factory<_i106.BookmarkBloc>(() => _i106.BookmarkBloc(
      get<_i71.BookmarkFetchUseCase>(), get<_i72.BookmarkRemovalUseCase>()));
  gh.factory<_i107.CourseBloc>(() => _i107.CourseBloc(
      get<_i77.CourseFetchUseCase>(),
      get<_i70.BookmarkAdditionUseCase>(),
      get<_i72.BookmarkRemovalUseCase>()));
  gh.factory<_i108.CourseDetailsBloc>(() => _i108.CourseDetailsBloc(
      get<_i76.CourseDetailsFetchUseCase>(),
      get<_i78.CourseLessonsFetchUseCase>(),
      get<_i23.CourseReviewsFetchUseCase>()));
  gh.factory<_i109.EditProfileBloc>(() => _i109.EditProfileBloc(
      get<_i84.GetCountriesUseCase>(), get<_i69.UpdateProfileUseCase>()));
  gh.factory<_i110.HomeBloc>(() => _i110.HomeBloc(get<_i88.HomeFetchUseCase>(),
      get<_i70.BookmarkAdditionUseCase>(), get<_i72.BookmarkRemovalUseCase>()));
  gh.factory<_i111.NotificationBloc>(
      () => _i111.NotificationBloc(get<_i96.NotificationFetchUseCase>()));
  gh.factory<_i112.SearchBloc>(() => _i112.SearchBloc(
      get<_i102.SearchFetchUseCase>(),
      get<_i100.RecentSearchFetchUseCase>(),
      get<_i99.RecentSearchAdditionUseCase>(),
      get<_i101.RecentSearchRemovalUseCase>(),
      get<_i70.BookmarkAdditionUseCase>(),
      get<_i72.BookmarkRemovalUseCase>()));
  return get;
}
