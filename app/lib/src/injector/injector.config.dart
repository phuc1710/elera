...
import '../data/datasources/remote/notification_api_service.dart' as _i52;
import '../data/datasources/remote/search_api_service.dart' as _i62;
...
import '../data/repositories/notification_repository_impl.dart' as _i54;
import '../data/repositories/search_repository_impl.dart' as _i64;
...
import '../domain/repositories/notification_repository.dart' as _i53;
import '../domain/repositories/search_repository.dart' as _i63;
...
import '../domain/usecases/clear_cache_usecase.dart' as _i72;
import '../domain/usecases/create_new_pin_usecase.dart' as _i24;
import '../domain/usecases/fill_your_profile_usecase.dart' as _i28;
import '../domain/usecases/get_bookmark_fetch_usecase.dart' as _i70;
import '../domain/usecases/get_contact_fetch_usecase.dart' as _i18;
import '../domain/usecases/get_countries_usecase.dart' as _i83;
import '../domain/usecases/get_course_details_fetch_usecase.dart' as _i75;
import '../domain/usecases/get_course_fetch_usecase.dart' as _i76;
import '../domain/usecases/get_course_lessons_fetch_usecase.dart' as _i77;
...
import '../domain/usecases/get_helper_center_usecase.dart' as _i84;
import '../domain/usecases/get_home_fetch_usecase.dart' as _i87;
import '../domain/usecases/get_invite_friends_usecase.dart' as _i30;
import '../domain/usecases/get_languages_usecase.dart' as _i85;
import '../domain/usecases/get_mentor_courses_fetch_usecase.dart' as _i90;
import '../domain/usecases/get_mentor_fetch_usecase.dart' as _i92;
...
import '../domain/usecases/get_notification_fetch_usecase.dart' as _i95;
import '../domain/usecases/get_payments_usecase.dart' as _i31;
import '../domain/usecases/get_pin_sending_usecase.dart' as _i57;
import '../domain/usecases/get_profile_usecase.dart' as _i32;
import '../domain/usecases/get_recent_search_fetch_usecase.dart' as _i99;
import '../domain/usecases/get_search_fetch_usecase.dart' as _i101;
...
import '../domain/usecases/post_bookmark_addition_usecase.dart' as _i69;
import '../domain/usecases/post_bookmark_removal_usecase.dart' as _i71;
import '../domain/usecases/post_contact_selection_usecase.dart' as _i19;
import '../domain/usecases/post_enroll_course_usecase.dart' as _i59;
import '../domain/usecases/post_password_creation_usecase.dart' as _i55;
import '../domain/usecases/post_pin_validation_usecase.dart' as _i58;
import '../domain/usecases/post_recent_search_addition_usecase.dart' as _i98;
import '../domain/usecases/post_recent_search_removal_usecase.dart' as _i100;
import '../domain/usecases/sign_in_usecase.dart' as _i65;
import '../domain/usecases/sign_up_usecase.dart' as _i66;
import '../domain/usecases/update_profile_usecase.dart' as _i68;
import '../module/register_module.dart' as _i112;
...
import '../presentation/course_detail_payment_enroll/review/bloc/review_bloc.dart'
    as _i61;
import '../presentation/edit_profile/bloc/edit_profile_bloc.dart' as _i108;
...
import '../presentation/friends_invitation/bloc/friends_invitation_bloc.dart'
    as _i82;
import '../presentation/help_center/bloc/helper_center_bloc.dart' as _i86;
import '../presentation/home_and_action_menu/home/bloc/home_bloc.dart' as _i109;
...
import '../presentation/home_and_action_menu/top_mentors/bloc/top_mentors_bloc.dart'
    as _i104;
import '../presentation/language/bloc/language_bloc.dart' as _i88;
import '../presentation/lets_in/sign_in/bloc/sign_in_bloc.dart' as _i102;
import '../presentation/lets_in/sign_up/bloc/sign_up_bloc.dart' as _i103;
import '../presentation/my_course/my_completed_course/bloc/my_complete_course_bloc.dart'
    as _i93;
import '../presentation/my_course/my_courses/bloc/my_course_bloc.dart' as _i94;
import '../presentation/new_card/bloc/new_card_bloc.dart' as _i51;
import '../presentation/payment/bloc/payment_bloc.dart' as _i56;
import '../presentation/profile/bloc/profile_bloc.dart' as _i60;
import '../presentation/transactions/bloc/transactions_bloc.dart' as _i67;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i51.NewCardBloc>(
      () => _i51.NewCardBloc(get<_i14.AddNewCardUseCase>()));
  gh.lazySingleton<_i52.NotificationApiService>(() =>
      registerModule.notificationApiService(
          get<_i4.Dio>(instanceName: 'ApiDio'),
          get<String>(instanceName: 'ApiBaseUrl')));
  gh.factory<_i53.NotificationRepository>(() =>
      _i54.NotificationRepositoryImpl(get<_i52.NotificationApiService>()));
  gh.factory<_i55.PasswordCreationUseCase>(
      () => _i55.PasswordCreationUseCase(get<_i10.UserRepository>()));
  gh.factory<_i56.PaymentBloc>(
      () => _i56.PaymentBloc(get<_i31.GetPaymentsUseCase>()));
  gh.factory<_i57.PinSendingUseCase>(
      () => _i57.PinSendingUseCase(get<_i10.UserRepository>()));
  gh.factory<_i58.PinValidationUseCase>(
      () => _i58.PinValidationUseCase(get<_i10.UserRepository>()));
  gh.factory<_i59.PostEnrollCourseUseCase>(
      () => _i59.PostEnrollCourseUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i60.ProfileBloc>(() => _i60.ProfileBloc(
      get<_i32.GetProfileUseCase>(), get<_i42.LanguageUseCase>()));
  gh.factory<_i61.ReviewBloc>(
      () => _i61.ReviewBloc(get<_i23.CourseReviewsFetchUseCase>()));
  gh.lazySingleton<_i62.SearchApiService>(() => registerModule.searchApiService(
      get<_i4.Dio>(instanceName: 'ApiDio'),
      get<String>(instanceName: 'ApiBaseUrl')));
  gh.factory<_i63.SearchRepository>(
      () => _i64.SearchRepositoryImpl(get<_i62.SearchApiService>()));
  gh.factory<_i65.SignInUseCase>(
      () => _i65.SignInUseCase(get<_i10.UserRepository>()));
  gh.factory<_i66.SignUpUseCase>(
      () => _i66.SignUpUseCase(get<_i10.UserRepository>()));
  gh.factory<_i67.TransactionsBloc>(
      () => _i67.TransactionsBloc(get<_i33.GetTransactionsUseCase>()));
  gh.factory<_i68.UpdateProfileUseCase>(
      () => _i68.UpdateProfileUseCase(get<_i10.UserRepository>()));
  gh.factory<_i69.BookmarkAdditionUseCase>(
      () => _i69.BookmarkAdditionUseCase(get<_i16.BookmarkRepository>()));
  gh.factory<_i70.BookmarkFetchUseCase>(
      () => _i70.BookmarkFetchUseCase(get<_i16.BookmarkRepository>()));
  gh.factory<_i71.BookmarkRemovalUseCase>(
      () => _i71.BookmarkRemovalUseCase(get<_i16.BookmarkRepository>()));
  gh.factory<_i72.ClearCacheUseCase>(
      () => _i72.ClearCacheUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i73.ConfirmPaymentBloc>(
      () => _i73.ConfirmPaymentBloc(get<_i58.PinValidationUseCase>()));
  gh.factory<_i74.ContactSelectionBloc>(() => _i74.ContactSelectionBloc(
      get<_i19.ContactSelectionUseCase>(), get<_i18.ContactFetchUseCase>()));
  gh.factory<_i75.CourseDetailsFetchUseCase>(
      () => _i75.CourseDetailsFetchUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i76.CourseFetchUseCase>(
      () => _i76.CourseFetchUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i77.CourseLessonsFetchUseCase>(
      () => _i77.CourseLessonsFetchUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i78.CreateNewPinBloc>(
      () => _i78.CreateNewPinBloc(get<_i24.CreateNewPinUseCase>()));
  gh.factory<_i79.EReceiptBloc>(
      () => _i79.EReceiptBloc(get<_i29.GetEReceiptUseCase>()));
  gh.factory<_i80.EnrollCourseBloc>(() => _i80.EnrollCourseBloc(
      get<_i31.GetPaymentsUseCase>(), get<_i59.PostEnrollCourseUseCase>()));
  gh.factory<_i81.FillYourProfileBloc>(
      () => _i81.FillYourProfileBloc(get<_i28.FillYourProfileUseCase>()));
  gh.factory<_i82.FriendsInvitationBloc>(() => _i82.FriendsInvitationBloc(
      get<_i30.GetInviteFriendsUseCase>(), get<_i40.InviteFriendUseCase>()));
  gh.factory<_i83.GetCountriesUseCase>(
      () => _i83.GetCountriesUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i84.GetHelperCenterUseCase>(
      () => _i84.GetHelperCenterUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i85.GetLanguagesUseCase>(
      () => _i85.GetLanguagesUseCase(get<_i35.HelperRepository>()));
  gh.factory<_i86.HelperCenterBloc>(
      () => _i86.HelperCenterBloc(get<_i84.GetHelperCenterUseCase>()));
  gh.factory<_i87.HomeFetchUseCase>(
      () => _i87.HomeFetchUseCase(get<_i38.HomeRepository>()));
  gh.factory<_i88.LanguageBloc>(() => _i88.LanguageBloc(
      get<_i85.GetLanguagesUseCase>(), get<_i41.LanguageSaveUseCase>()));
  gh.factory<_i89.LessonBloc>(
      () => _i89.LessonBloc(get<_i77.CourseLessonsFetchUseCase>()));
  gh.factory<_i90.MentorCoursesFetchUseCase>(
      () => _i90.MentorCoursesFetchUseCase(get<_i45.MentorRepository>()));
  gh.factory<_i91.MentorDetailsBloc>(() => _i91.MentorDetailsBloc(
      get<_i90.MentorCoursesFetchUseCase>(),
      get<_i48.MentorStudentsFetchUseCase>(),
      get<_i47.MentorReviewsFetchUseCase>()));
  gh.factory<_i92.MentorFetchUseCase>(
      () => _i92.MentorFetchUseCase(get<_i45.MentorRepository>()));
  gh.factory<_i93.MyCompleteCourseBloc>(
      () => _i93.MyCompleteCourseBloc(get<_i49.MyCourseDetailFetchUseCase>()));
  gh.factory<_i94.MyCourseBloc>(
      () => _i94.MyCourseBloc(get<_i50.MyCourseFetchUseCase>()));
  gh.factory<_i95.NotificationFetchUseCase>(
      () => _i95.NotificationFetchUseCase(get<_i53.NotificationRepository>()));
  gh.factory<_i96.PasswordCreationBloc>(
      () => _i96.PasswordCreationBloc(get<_i55.PasswordCreationUseCase>()));
  gh.factory<_i97.PinEntryBloc>(() => _i97.PinEntryBloc(
      get<_i57.PinSendingUseCase>(), get<_i58.PinValidationUseCase>()));
  gh.factory<_i98.RecentSearchAdditionUseCase>(
      () => _i98.RecentSearchAdditionUseCase(get<_i63.SearchRepository>()));
  gh.factory<_i99.RecentSearchFetchUseCase>(
      () => _i99.RecentSearchFetchUseCase(get<_i63.SearchRepository>()));
  gh.factory<_i100.RecentSearchRemovalUseCase>(
      () => _i100.RecentSearchRemovalUseCase(get<_i63.SearchRepository>()));
  gh.factory<_i101.SearchFetchUseCase>(
      () => _i101.SearchFetchUseCase(get<_i63.SearchRepository>()));
  gh.factory<_i102.SignInBloc>(() => _i102.SignInBloc(
      get<_i65.SignInUseCase>(), get<_i12.AccessTokenSaveUseCase>()));
  gh.factory<_i103.SignUpBloc>(
      () => _i103.SignUpBloc(get<_i66.SignUpUseCase>()));
  gh.factory<_i104.TopMentorsBloc>(
      () => _i104.TopMentorsBloc(get<_i92.MentorFetchUseCase>()));
  gh.factory<_i105.BookmarkBloc>(() => _i105.BookmarkBloc(
      get<_i70.BookmarkFetchUseCase>(), get<_i71.BookmarkRemovalUseCase>()));
  gh.factory<_i106.CourseBloc>(() => _i106.CourseBloc(
      get<_i76.CourseFetchUseCase>(),
      get<_i69.BookmarkAdditionUseCase>(),
      get<_i71.BookmarkRemovalUseCase>()));
  gh.factory<_i107.CourseDetailsBloc>(() => _i107.CourseDetailsBloc(
      get<_i75.CourseDetailsFetchUseCase>(),
      get<_i77.CourseLessonsFetchUseCase>(),
      get<_i23.CourseReviewsFetchUseCase>()));
  gh.factory<_i108.EditProfileBloc>(() => _i108.EditProfileBloc(
      get<_i83.GetCountriesUseCase>(), get<_i68.UpdateProfileUseCase>()));
  gh.factory<_i109.HomeBloc>(() => _i109.HomeBloc(get<_i87.HomeFetchUseCase>(),
      get<_i69.BookmarkAdditionUseCase>(), get<_i71.BookmarkRemovalUseCase>()));
  gh.factory<_i110.NotificationBloc>(
      () => _i110.NotificationBloc(get<_i95.NotificationFetchUseCase>()));
  gh.factory<_i111.SearchBloc>(() => _i111.SearchBloc(
      get<_i101.SearchFetchUseCase>(),
      get<_i99.RecentSearchFetchUseCase>(),
      get<_i98.RecentSearchAdditionUseCase>(),
      get<_i100.RecentSearchRemovalUseCase>(),
      get<_i69.BookmarkAdditionUseCase>(),
      get<_i71.BookmarkRemovalUseCase>()));
  return get;
}
