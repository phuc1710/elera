...
import '../domain/usecases/get_countries_usecase.dart' as _i72;
import '../domain/usecases/get_course_fetch_usecase.dart' as _i67;
import '../domain/usecases/get_e_receipt_usecase.dart' as _i28;
import '../domain/usecases/get_helper_center_usecase.dart' as _i73;
import '../domain/usecases/get_home_fetch_usecase.dart' as _i76;
import '../domain/usecases/get_invite_friends_usecase.dart' as _i29;
import '../domain/usecases/get_languages_usecase.dart' as _i74;
import '../domain/usecases/get_mentor_fetch_usecase.dart' as _i78;
import '../domain/usecases/get_notification_fetch_usecase.dart' as _i79;
...
import '../domain/usecases/get_recent_search_fetch_usecase.dart' as _i83;
import '../domain/usecases/get_search_fetch_usecase.dart' as _i85;
...
import '../domain/usecases/post_recent_search_addition_usecase.dart' as _i82;
import '../domain/usecases/post_recent_search_removal_usecase.dart' as _i84;
...
import '../module/register_module.dart' as _i95;
...
import '../presentation/account_setup/fill_your_profile/bloc/fill_your_profile_bloc.dart'
    as _i70;
import '../presentation/edit_profile/bloc/edit_profile_bloc.dart' as _i91;
...
import '../presentation/friends_invitation/bloc/friends_invitation_bloc.dart'
    as _i71;
import '../presentation/help_center/bloc/helper_center_bloc.dart' as _i75;
import '../presentation/home_and_action_menu/home/bloc/home_bloc.dart' as _i92;
...
import '../presentation/home_and_action_menu/top_mentors/bloc/top_mentors_bloc.dart'
    as _i88;
import '../presentation/language/bloc/language_bloc.dart' as _i77;
import '../presentation/letsin/signin/bloc/signin_bloc.dart' as _i86;
import '../presentation/letsin/signup/bloc/signup_bloc.dart' as _i87;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i67.CourseFetchUseCase>(
      () => _i67.CourseFetchUseCase(get<_i21.CourseRepository>()));
  gh.factory<_i68.CreateNewPinBloc>(
      () => _i68.CreateNewPinBloc(get<_i23.CreateNewPinUseCase>()));
  gh.factory<_i69.EReceiptBloc>(
      () => _i69.EReceiptBloc(get<_i28.GetEReceiptUseCase>()));
  gh.factory<_i70.FillYourProfileBloc>(
      () => _i70.FillYourProfileBloc(get<_i27.FillYourProfileUseCase>()));
  gh.factory<_i71.FriendsInvitationBloc>(() => _i71.FriendsInvitationBloc(
      get<_i29.GetInviteFriendsUseCase>(), get<_i39.InviteFriendUseCase>()));
  gh.factory<_i72.GetCountriesUseCase>(
      () => _i72.GetCountriesUseCase(get<_i34.HelperRepository>()));
  gh.factory<_i73.GetHelperCenterUseCase>(
      () => _i73.GetHelperCenterUseCase(get<_i34.HelperRepository>()));
  gh.factory<_i74.GetLanguagesUseCase>(
      () => _i74.GetLanguagesUseCase(get<_i34.HelperRepository>()));
  gh.factory<_i75.HelperCenterBloc>(
      () => _i75.HelperCenterBloc(get<_i73.GetHelperCenterUseCase>()));
  gh.factory<_i76.HomeFetchUseCase>(
      () => _i76.HomeFetchUseCase(get<_i37.HomeRepository>()));
  gh.factory<_i77.LanguageBloc>(() => _i77.LanguageBloc(
      get<_i74.GetLanguagesUseCase>(), get<_i40.LanguageSaveUseCase>()));
  gh.factory<_i78.MentorFetchUseCase>(
      () => _i78.MentorFetchUseCase(get<_i44.MentorRepository>()));
  gh.factory<_i79.NotificationFetchUseCase>(
      () => _i79.NotificationFetchUseCase(get<_i48.NotificationRepository>()));
  gh.factory<_i80.PasswordCreationBloc>(
      () => _i80.PasswordCreationBloc(get<_i50.PasswordCreationUseCase>()));
  gh.factory<_i81.PinEntryBloc>(() => _i81.PinEntryBloc(
      get<_i53.PinSendingUseCase>(), get<_i52.PinEntryUseCase>()));
  gh.factory<_i82.RecentSearchAdditionUseCase>(
      () => _i82.RecentSearchAdditionUseCase(get<_i56.SearchRepository>()));
  gh.factory<_i83.RecentSearchFetchUseCase>(
      () => _i83.RecentSearchFetchUseCase(get<_i56.SearchRepository>()));
  gh.factory<_i84.RecentSearchRemovalUseCase>(
      () => _i84.RecentSearchRemovalUseCase(get<_i56.SearchRepository>()));
  gh.factory<_i85.SearchFetchUseCase>(
      () => _i85.SearchFetchUseCase(get<_i56.SearchRepository>()));
  gh.factory<_i86.SignInBloc>(() => _i86.SignInBloc(
      get<_i58.SignInUseCase>(), get<_i12.AccessTokenSaveUseCase>()));
  gh.factory<_i87.SignUpBloc>(() => _i87.SignUpBloc(get<_i59.SignUpUseCase>()));
  gh.factory<_i88.TopMentorsBloc>(
      () => _i88.TopMentorsBloc(get<_i78.MentorFetchUseCase>()));
  gh.factory<_i89.BookmarkBloc>(() => _i89.BookmarkBloc(
      get<_i63.BookmarkFetchUseCase>(), get<_i64.BookmarkRemovalUseCase>()));
  gh.factory<_i90.CourseBloc>(() => _i90.CourseBloc(
      get<_i67.CourseFetchUseCase>(),
      get<_i62.BookmarkAdditionUseCase>(),
      get<_i64.BookmarkRemovalUseCase>()));
  gh.factory<_i91.EditProfileBloc>(() => _i91.EditProfileBloc(
      get<_i72.GetCountriesUseCase>(), get<_i61.UpdateProfileUseCase>()));
  gh.factory<_i92.HomeBloc>(() => _i92.HomeBloc(get<_i76.HomeFetchUseCase>(),
      get<_i62.BookmarkAdditionUseCase>(), get<_i64.BookmarkRemovalUseCase>()));
  gh.factory<_i93.NotificationBloc>(
      () => _i93.NotificationBloc(get<_i79.NotificationFetchUseCase>()));
  gh.factory<_i94.SearchBloc>(() => _i94.SearchBloc(
      get<_i85.SearchFetchUseCase>(),
      get<_i83.RecentSearchFetchUseCase>(),
      get<_i82.RecentSearchAdditionUseCase>(),
      get<_i84.RecentSearchRemovalUseCase>(),
      get<_i62.BookmarkAdditionUseCase>(),
      get<_i64.BookmarkRemovalUseCase>()));
  return get;
}
