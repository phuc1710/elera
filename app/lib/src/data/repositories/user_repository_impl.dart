...
class UserRepositoryImpl implements UserRepository {
  ...
  Future<DataState<SignUpResponseModel>> postSignUpRequest(
    ...
    try {
      final httpResponse =
          await _userApiService.postSignUpRequest(isMockup: true, body: params);
  ...
  Future<DataState<MyCourseFetchResponseModel>> getMyCourseFetchRequest(
    ...
    try {
      final httpResponse = await _userApiService.getMyCourseFetchRequest(
        isMockup: true,
        body: params,
      );
  ...
  @override
  Future<DataState<MyCourseDetailFetchResponseModel>>
      getMyCourseDetailFetchRequest(
    MyCourseDetailFetchRequestParams? params,
  ) async {
    try {
      final httpResponse = await _userApiService.getMyCourseDetailFetchRequest(
        isMockup: true,
        query: params,
      );
