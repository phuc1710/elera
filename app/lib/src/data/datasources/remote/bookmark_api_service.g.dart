...
class _BookmarkApiService implements BookmarkApiService {
  ...
  Future<HttpResponse<BookmarkFetchResponseModel>> getBookmarkFetchRequest({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BookmarkFetchResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<BookmarkAdditionResponseModel>>
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BookmarkAdditionResponseModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<BookmarkRemovalResponseModel>>
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BookmarkRemovalResponseModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
