...
class _HelperApiService implements HelperApiService {
  ...
  Future<HttpResponse<LanguageResponseModel?>> getLanguages({isMockup}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<HttpResponse<LanguageResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<EditProfileResponseModel?>> getCountries(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<HttpResponse<EditProfileResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<HelperCenterResponseModel?>> getHelperCenter(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<HttpResponse<HelperCenterResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
