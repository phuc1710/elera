...
import '../data/datasources/remote/search_api_service.dart' as _i40;
...
import '../data/repositories/search_repository_impl.dart' as _i42;
...
import '../domain/repositories/search_repository.dart' as _i41;
...
import '../domain/usecases/get_bookmark_fetch_usecase.dart' as _i47;
import '../domain/usecases/get_contact_fetch_usecase.dart' as _i11;
import '../domain/usecases/get_countries_usecase.dart' as _i54;
import '../domain/usecases/get_course_fetch_usecase.dart' as _i50;
import '../domain/usecases/get_helper_center_usecase.dart' as _i55;
import '../domain/usecases/get_home_fetch_usecase.dart' as _i58;
import '../domain/usecases/get_invite_friends_usecase.dart' as _i18;
import '../domain/usecases/get_languages_usecase.dart' as _i56;
import '../domain/usecases/get_mentor_fetch_usecase.dart' as _i60;
import '../domain/usecases/get_notification_fetch_usecase.dart' as _i61;
...
import '../domain/usecases/get_recent_search_fetch_usecase.dart' as _i65;
import '../domain/usecases/get_search_fetch_usecase.dart' as _i67;
import '../domain/usecases/invite_friend_usecase.dart' as _i27;
import '../domain/usecases/post_bookmark_addition_usecase.dart' as _i46;
import '../domain/usecases/post_bookmark_removal_usecase.dart' as _i48;
...
import '../domain/usecases/post_recent_search_addition_usecase.dart' as _i64;
import '../domain/usecases/post_recent_search_removal_usecase.dart' as _i66;
import '../domain/usecases/sign_in_usecase.dart' as _i43;
import '../domain/usecases/sign_up_usecase.dart' as _i44;
import '../domain/usecases/update_profile_usecase.dart' as _i45;
import '../module/register_module.dart' as _i77;
...
import '../presentation/account_setup/fill_your_profile/bloc/fill_your_profile_bloc.dart'
    as _i52;
import '../presentation/edit_profile/bloc/edit_profile_bloc.dart' as _i73;
...
import '../presentation/friends_invitation/bloc/friends_invitation_bloc.dart'
    as _i53;
import '../presentation/help_center/bloc/helper_center_bloc.dart' as _i57;
import '../presentation/home_and_action_menu/home/bloc/home_bloc.dart' as _i74;
...
import '../presentation/home_and_action_menu/top_mentors/bloc/top_mentors_bloc.dart'
    as _i70;
import '../presentation/language/bloc/language_bloc.dart' as _i59;
import '../presentation/letsin/signin/bloc/signin_bloc.dart' as _i68;
import '../presentation/letsin/signup/bloc/signup_bloc.dart' as _i69;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i40.SearchApiService>(() => registerModule.searchApiService(
      get<_i3.Dio>(instanceName: 'ApiDio'),
      get<String>(instanceName: 'ApiBaseUrl')));
  gh.factory<_i41.SearchRepository>(
      () => _i42.SearchRepositoryImpl(get<_i40.SearchApiService>()));
  gh.factory<_i43.SignInUseCase>(
      () => _i43.SignInUseCase(get<_i5.UserRepository>()));
  gh.factory<_i44.SignUpUseCase>(
      () => _i44.SignUpUseCase(get<_i5.UserRepository>()));
  gh.factory<_i45.UpdateProfileUseCase>(
      () => _i45.UpdateProfileUseCase(get<_i5.UserRepository>()));
  gh.factory<_i46.BookmarkAdditionUseCase>(
      () => _i46.BookmarkAdditionUseCase(get<_i9.BookmarkRepository>()));
  gh.factory<_i47.BookmarkFetchUseCase>(
      () => _i47.BookmarkFetchUseCase(get<_i9.BookmarkRepository>()));
  gh.factory<_i48.BookmarkRemovalUseCase>(
      () => _i48.BookmarkRemovalUseCase(get<_i9.BookmarkRepository>()));
  gh.factory<_i49.ContactSelectionBloc>(() => _i49.ContactSelectionBloc(
      get<_i12.ContactSelectionUseCase>(), get<_i11.ContactFetchUseCase>()));
  gh.factory<_i50.CourseFetchUseCase>(
      () => _i50.CourseFetchUseCase(get<_i14.CourseRepository>()));
  gh.factory<_i51.CreateNewPinBloc>(
      () => _i51.CreateNewPinBloc(get<_i16.CreateNewPinUseCase>()));
  gh.factory<_i52.FillYourProfileBloc>(
      () => _i52.FillYourProfileBloc(get<_i17.FillYourProfileUseCase>()));
  gh.factory<_i53.FriendsInvitationBloc>(() => _i53.FriendsInvitationBloc(
      get<_i18.GetInviteFriendsUseCase>(), get<_i27.InviteFriendUseCase>()));
  gh.factory<_i54.GetCountriesUseCase>(
      () => _i54.GetCountriesUseCase(get<_i22.HelperRepository>()));
  gh.factory<_i55.GetHelperCenterUseCase>(
      () => _i55.GetHelperCenterUseCase(get<_i22.HelperRepository>()));
  gh.factory<_i56.GetLanguagesUseCase>(
      () => _i56.GetLanguagesUseCase(get<_i22.HelperRepository>()));
  gh.factory<_i57.HelperCenterBloc>(
      () => _i57.HelperCenterBloc(get<_i55.GetHelperCenterUseCase>()));
  gh.factory<_i58.HomeFetchUseCase>(
      () => _i58.HomeFetchUseCase(get<_i25.HomeRepository>()));
  gh.factory<_i59.LanguageBloc>(
      () => _i59.LanguageBloc(get<_i56.GetLanguagesUseCase>()));
  gh.factory<_i60.MentorFetchUseCase>(
      () => _i60.MentorFetchUseCase(get<_i29.MentorRepository>()));
  gh.factory<_i61.NotificationFetchUseCase>(
      () => _i61.NotificationFetchUseCase(get<_i33.NotificationRepository>()));
  gh.factory<_i62.PasswordCreationBloc>(
      () => _i62.PasswordCreationBloc(get<_i35.PasswordCreationUseCase>()));
  gh.factory<_i63.PinEntryBloc>(() => _i63.PinEntryBloc(
      get<_i38.PinSendingUseCase>(), get<_i37.PinEntryUseCase>()));
  gh.factory<_i64.RecentSearchAdditionUseCase>(
      () => _i64.RecentSearchAdditionUseCase(get<_i41.SearchRepository>()));
  gh.factory<_i65.RecentSearchFetchUseCase>(
      () => _i65.RecentSearchFetchUseCase(get<_i41.SearchRepository>()));
  gh.factory<_i66.RecentSearchRemovalUseCase>(
      () => _i66.RecentSearchRemovalUseCase(get<_i41.SearchRepository>()));
  gh.factory<_i67.SearchFetchUseCase>(
      () => _i67.SearchFetchUseCase(get<_i41.SearchRepository>()));
  gh.factory<_i68.SignInBloc>(() => _i68.SignInBloc(get<_i43.SignInUseCase>()));
  gh.factory<_i69.SignUpBloc>(() => _i69.SignUpBloc(get<_i44.SignUpUseCase>()));
  gh.factory<_i70.TopMentorsBloc>(
      () => _i70.TopMentorsBloc(get<_i60.MentorFetchUseCase>()));
  gh.factory<_i71.BookmarkBloc>(() => _i71.BookmarkBloc(
      get<_i47.BookmarkFetchUseCase>(), get<_i48.BookmarkRemovalUseCase>()));
  gh.factory<_i72.CourseBloc>(() => _i72.CourseBloc(
      get<_i50.CourseFetchUseCase>(),
      get<_i46.BookmarkAdditionUseCase>(),
      get<_i48.BookmarkRemovalUseCase>()));
  gh.factory<_i73.EditProfileBloc>(() => _i73.EditProfileBloc(
      get<_i54.GetCountriesUseCase>(), get<_i45.UpdateProfileUseCase>()));
  gh.factory<_i74.HomeBloc>(() => _i74.HomeBloc(get<_i58.HomeFetchUseCase>(),
      get<_i46.BookmarkAdditionUseCase>(), get<_i48.BookmarkRemovalUseCase>()));
  gh.factory<_i75.NotificationBloc>(
      () => _i75.NotificationBloc(get<_i61.NotificationFetchUseCase>()));
  gh.factory<_i76.SearchBloc>(() => _i76.SearchBloc(
      get<_i67.SearchFetchUseCase>(),
      get<_i65.RecentSearchFetchUseCase>(),
      get<_i64.RecentSearchAdditionUseCase>(),
      get<_i66.RecentSearchRemovalUseCase>(),
      get<_i46.BookmarkAdditionUseCase>(),
      get<_i48.BookmarkRemovalUseCase>()));
  return get;
}
